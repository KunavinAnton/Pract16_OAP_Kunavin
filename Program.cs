...
namespace Pract16_OAP_Kunavin
{
    class Program
    {
        public static void Zadanie1()
        {
            ...
            var value = array.Where(x => x == word);
        ...
        public static void Zadanie2()
        {
            ...
            if (x == "3")
            {
                ...
                if (n1) { value = value.ToLower(); } else { value = value.ToUpper(); }
                Console.WriteLine(value);
        ...
        public static void Zadanie3()
        {
            ...
            //var value = Arr1.Where(x => Arr1.Count(y => x == y) > 1);
        }
